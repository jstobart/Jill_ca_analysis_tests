...
%load data traces
%load('E:\Data\Two_Photon_Data\GCaMP_RCaMP\cyto_GCaMP6s\Results\DSP4_cGC&RC_traces_14_02_2017.mat');
load('D:\Data\GCaMP_RCaMP\cyto_GCaMP6s\Results\DSP4_cGC&RC_traces_14_02_2017.mat');
...
XLfile = 'D:\Data\GCaMP_RCaMP\cyto_GCaMP6s\Results\respondingROIs_DSP4longstim.xlsx';
...
for xROI= 1:size(timeDiffs,1)
    ...
    cell2csv('DSP4LongStim_TimeDiffs.csv',AllTimeDiffs);
