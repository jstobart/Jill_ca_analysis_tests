...
SaveFiles{1,1} = fullfile(Settings.MainDir, 'Results','FilesforR', 'example_allMice_cyto_nostim_vs_longstim_12_2017.csv'); % peak data for R
SaveFiles{1,2} = fullfile(Settings.MainDir, 'Results','FilesforMatlab', 'example_allMice_cyto_nostim_vs_longstim_12_2017.mat'); % peak dat for matlab
SaveFiles{1,3}= fullfile(Settings.MainDir, 'Results','FilesforMatlab','example_allMice_cyto_nostim_vs_longstim_12_2017.mat');
SaveFiles{1,4}= fullfile(Settings.MainDir, 'Results','FilesforR','example_allMice_cyto_nostim_vs_longstim_12_2017.csv');
