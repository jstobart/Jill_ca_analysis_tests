...
Settings.ScoreSheetNames = {
    'WT_LR1_Scoresheet_AllTrials.xls',...
    'IPRG5_Scoresheet_AllTrials.xls',...
    'IPRG6_Scoresheet_AllTrials.xls',...
    'IPRG7_Scoresheet_AllTrials.xls',...
    'WT_LR4_Scoresheet_AllTrials.xls',...
    };
Settings.NameConditions = {'Nostim','Stim'};
Settings.IP3R2KO = {'IPRG5','IPRG6'};
Settings.IP3R2WT = {'IPRG6'};

channel = struct('Ca_Memb_Astro',1,'Ca_Neuron',2);
plotMotion =0;

% final data file name
SaveFiles{1,1} = fullfile(Settings.MainDir, 'Results','FilesforR', 'Peaks_2ndCohort_Lck_nostim_vs_longstim_01_2018.csv'); % peak data for R
SaveFiles{1,2} = fullfile(Settings.MainDir, 'Results','FilesforMatlab', 'Peaks_2ndCohort_Lck_nostim_vs_longstim_01_2018.mat'); % peak dat for matlab
SaveFiles{1,3}= fullfile(Settings.MainDir, 'Results','FilesforMatlab','Traces_2ndCohort_Lck_nostim_vs_longstim_01_2018.mat');
SaveFiles{1,4}= fullfile(Settings.MainDir, 'Results','FilesforR','OnsetTimes_2ndCohort_Lck_nostim_vs_longstim_01_2018.csv');
...
%     'IPRG1_Scoresheet_AllTrials.xls',...
%     'IPRG2_Scoresheet_AllTrials.xls',...
%     'IPRG3_Scoresheet_AllTrials.xls',...
...
% 
% % final data file name
% SaveFiles{1,1} = fullfile(Settings.MainDir, 'Results','FilesforR', 'Peaks_allMice_Lck_nostim_vs_longstim_12_2017.csv'); % peak data for R
% SaveFiles{1,2} = fullfile(Settings.MainDir, 'Results','FilesforMatlab', 'Peaks_allMice_Lck_nostim_vs_longstim_12_2017.mat'); % peak dat for matlab
% SaveFiles{1,3}= fullfile(Settings.MainDir, 'Results','FilesforMatlab','Traces_allMice_Lck_nostim_vs_longstim_12_2017.mat');
% SaveFiles{1,4}= fullfile(Settings.MainDir, 'Results','FilesforR','OnsetTimes_allMice_Lck_nostim_vs_longstim_12_2017.csv');
% %% Load calibration file
% calibration ='E:\matlab\CalibrationFiles\calibration_20x.mat';
% CalFile = CalibrationPixelSize.load(calibration);
% 
