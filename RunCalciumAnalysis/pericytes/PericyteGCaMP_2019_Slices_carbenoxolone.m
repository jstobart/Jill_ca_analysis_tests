...
SaveFiles{1,1} = fullfile(Settings.ResultsFolder,'GCaMPSlice_peaks_02_02_2020_baselineCarbenoxolone.csv');
SaveFiles{1,2} = fullfile(Settings.ResultsFolder,'GCaMPSlice_peaks_02_02_2020_baselineCarbenoxolone.mat');
SaveFiles{1,3}= fullfile(Settings.ResultsFolder,'GCaMPSlice_traces_02_02_2020_baselineCarbenoxolone.mat');

Drug='Cbx';
Settings.FileNames = {  % folder names where images and roiSet.zip is found
    'E:\Jill\Data\Winnipeg\Pericytes\Brain Slice 2P Data\PDGFRB-GCaMP\2019_12_05_cbx\baseline',...
    'E:\Jill\Data\Winnipeg\Pericytes\Brain Slice 2P Data\PDGFRB-GCaMP\2019_12_05_cbx\cbx',...
    };
