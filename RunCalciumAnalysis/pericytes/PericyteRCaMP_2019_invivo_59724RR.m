...
Settings.ResultsFolder = 'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\Results\Calcium Results\RCaMP 59724 RR';

channel = struct('Ca_Memb_Astro', 1,'blood_plasma',2);

% File names for saving
SaveFiles{1,1} = fullfile(Settings.ResultsFolder,'RCaMP_59724_peaks_nimodipine_02_2020.csv');
SaveFiles{1,2} = fullfile(Settings.ResultsFolder,'RCaMP_59724_peaks_nimodipine_02_2020.mat');
SaveFiles{1,3}= fullfile(Settings.ResultsFolder,'RCaMP_59724_traces_nimodipine_02_2020.mat');

Drug='nimodipine';
Animal='59724';

Settings.FileNames = {  % folder names where images and roiSet.zip is found
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_07_16 - nimodipine\spot1',...
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_07_16 - nimodipine\spot2',...
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_07_16 - nimodipine\spot3',...
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_08_02- nimodipine\spot4',...
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_08_02- nimodipine\spot5',...
    };
...
for iSpot= 1:length(Settings.FileNames)
    ...
    for iTrial= 1:length(TrialNames)
        ...
        %% Motion Correction
        if iTrial==1
            refImg=mean(ImgArray.rawdata(:,:,1,1:10),4);
        end
        
        ImgArray = ImgArray.motion_correct('refImg',refImg, 'ch',2,'maxShift', 10,'minCorr', 0.4, 'inpaintIters', 10);%,'doPlot',true);
...
%         
        ...
        % RCaMP parameters BandMin = 0.025, BandMax = 0.6
...
% File names for saving
SaveFiles{1,1} = fullfile(Settings.ResultsFolder,'RCaMP_59724_peaks_Pyr3_02_2020.csv');
SaveFiles{1,2} = fullfile(Settings.ResultsFolder,'RCaMP_59724_peaks_Pyr3_02_2020.mat');
SaveFiles{1,3}= fullfile(Settings.ResultsFolder,'RCaMP_59724_traces_Pyr3_02_2020.mat');

Drug='Pyr3';
Animal='59724';

Settings.FileNames = {  % folder names where images and roiSet.zip is found
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_07_19 - Pyr3\spot1',...
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_07_19 - Pyr3\spot2',...
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_07_19 - Pyr3\spot3',...
    };
...
% File names for saving
SaveFiles{1,1} = fullfile(Settings.ResultsFolder,'RCaMP_59724_peaks_baseline_02_2020.csv');
SaveFiles{1,2} = fullfile(Settings.ResultsFolder,'RCaMP_59724_peaks_baseline_02_2020.mat');
SaveFiles{1,3}= fullfile(Settings.ResultsFolder,'RCaMP_59724_traces_baseline_02_2020.mat');

Drug='baseline';
Animal='59724';

Settings.FileNames = {  % folder names where images and roiSet.zip is found
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_07_08 - KX\spot1',...
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_07_08 - KX\spot2',...
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_07_08 - KX\spot3',...
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_07_11 - KX\spot4',...
    'E:\Jill\Data\Winnipeg\Pericytes\In vivo 2P\RCaMP Mice\RCaMP 59724 RR\2019_07_11 - KX\spot5',...
    };
