...
SaveFiles{1,1}= fullfile(Settings.MainDir, 'Results','FilesforMatlab','LinescanTraces_2ndCohort_Lck_nostim_vs_longstim_01_2018.mat');
SaveFiles{1,2}= fullfile(Settings.MainDir, 'Results','FilesforR','LinescanOnsets_2ndCohort_Lck_nostim_vs_longstim_01_2018.csv');
...
% 
% %% 2 lck no stim vs long stim for all mice (independent of genotype)
% clearvars
% 
% All_traces= [];
% 
