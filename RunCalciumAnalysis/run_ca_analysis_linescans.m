...
SaveFiles{1,1}= fullfile(Settings.MainDir, 'Results','FilesforMatlab','LinescanTraces_AllMice_Lck_nostim_vs_longstim_01_2018.mat');
SaveFiles{1,2}= fullfile(Settings.MainDir, 'Results','FilesforR','LinescanOnsets_AllMice_Lck_nostim_vs_longstim_01_2018.csv');
