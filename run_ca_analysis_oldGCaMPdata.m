...
Settings.MainDir = 'E:\Data\Two_Photon_Data\GFAP_GCaMP6\Whisker_stim\Longstim';
...
for iAnimal = 1:numAnimals
    ...
    for iPath= 1:length(Settings.LowresPath)
        ...
        refImg = mean(HighRes.rawdata(:,:,1,:),4);
        %figure, imagesc(refImg), axis image, axis off, colormap(gray)
        
        ImgArray = ImgArray.motion_correct('refImg',refImg, 'ch',1,'minCorr', 0.4,'doPlot',true);
