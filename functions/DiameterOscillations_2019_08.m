...
Settings.Animal ='MJ';
Settings.SaveFile = {'Z:\Jill_Stobart\In_vivo_2P_Data\RCaMP 59721 R- MJ\Data for comparison\DiameterOscillationsAnalysis.csv'};

Settings.FileNames = {  % folder names where images and roiSet.zip is found
    'Z:\Jill_Stobart\In_vivo_2P_Data\RCaMP 59721 R- MJ\Data for comparison\SPOT4\Diam',...
    };
