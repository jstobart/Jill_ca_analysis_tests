...
load('J:\Noushin Ahmadpour\2P Data\Results\FilesforMatlab\12_control_traces_longtrials.mat');
mouse12=All_traces;

load('J:\Noushin Ahmadpour\2P Data\Results\FilesforMatlab\14_control_traces_longtrials.mat');
mouse14=All_traces;

load('J:\Noushin Ahmadpour\2P Data\Results\FilesforMatlab\15_control_traces_longtrials.mat');
mouse15=All_traces;

load('J:\Noushin Ahmadpour\2P Data\Results\FilesforMatlab\Crazy8_control_traces_longtrials.mat');
mouseC8=All_traces;

load('J:\Noushin Ahmadpour\2P Data\Results\FilesforMatlab\12_KD_traces_longtrials.mat');
mouse12_KD=All_traces;

load('J:\Noushin Ahmadpour\2P Data\Results\FilesforMatlab\14_KD_traces_longtrials.mat');
mouse14_KD=All_traces;

load('J:\Noushin Ahmadpour\2P Data\Results\FilesforMatlab\15_KD_traces_longtrials.mat');
mouse15_KD=All_traces;
...
NS=vertcat(mouse12, mouse14, mouseC8, mouse15);%;, mouse92, mouseCrazy8, mouseAlice); % non-silencing
KD=vertcat(mouse12_KD, mouse14_KD, mouse15_KD); % mouse94, mouse95, mouse96,  knock down

FrameRate=All_traces{1,11};
...
for xROI=1:size(KD,1)
    NostimIdxKD(xROI)= strcmp(KD{xROI,6},'Nostim');
end
KD_stim=KD(~NostimIdxKD',:);
...
%ylim([-0.2 3]);
lineProps.col = {blue};
mseb(TimeX,OT_RCaMP_mean',RC_SEM,lineProps)
lineProps.col = {green};
mseb(TimeX,(OT_RCaMP_mean2'+1),RC_SEM2,lineProps)
