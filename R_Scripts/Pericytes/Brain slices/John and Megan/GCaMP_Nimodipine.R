...
# load files
#baseline
GCaMPSlice_baseline_2019_07_11 <- read.table("C:/Users/John PC/Documents/Summer Research 2019/R-analysis/GCaMP Baseline Nimodipine files/GCaMPSlice_peaks_07_11_2019_Baseline.csv", header=TRUE, sep = ",")
GCaMPSlice_baseline_2019_07_12 <- read.table("C:/Users/John PC/Documents/Summer Research 2019/R-analysis/GCaMP Baseline Nimodipine files/GCaMPSlice_peaks_07_12_2019_Baseline.csv", header=TRUE, sep = ",")
GCaMPSlice_baseline_2019_07_15 <- read.table("C:/Users/John PC/Documents/Summer Research 2019/R-analysis/GCaMP Baseline Nimodipine files/GCaMPSlice_peaks_07_15_2019_Baseline.csv", header=TRUE, sep = ",")
GCaMPSlice_baseline_2019_07_16 <- read.table("C:/Users/John PC/Documents/Summer Research 2019/R-analysis/GCaMP Baseline Nimodipine files/GCaMPSlice_peaks_07_16_2019_Baseline.csv", header=TRUE, sep = ",")
GCaMPSlice_baseline_2019_07_17 <- read.table("C:/Users/John PC/Documents/Summer Research 2019/R-analysis/GCaMP Baseline Nimodipine files/GCaMPSlice_peaks_07_17_2019_Baseline.csv", header=TRUE, sep = ",")

#pyr3
GCaMPSlice_nimodipine_2019_07_11 <- read.table("C:/Users/John PC/Documents/Summer Research 2019/R-analysis/GCaMP Baseline Nimodipine files/GCaMPSlice_peaks_07_11_2019_Nimodipine.csv", header=TRUE, sep = ",")
GCaMPSlice_nimodipine_2019_07_12 <- read.table("C:/Users/John PC/Documents/Summer Research 2019/R-analysis/GCaMP Baseline Nimodipine files/GCaMPSlice_peaks_07_12_2019_Nimodipine.csv", header=TRUE, sep = ",")
GCaMPSlice_nimodipine_2019_07_15 <- read.table("C:/Users/John PC/Documents/Summer Research 2019/R-analysis/GCaMP Baseline Nimodipine files/GCaMPSlice_peaks_07_15_2019_Nimodipine.csv", header=TRUE, sep = ",")
GCaMPSlice_nimodipine_2019_07_16 <- read.table("C:/Users/John PC/Documents/Summer Research 2019/R-analysis/GCaMP Baseline Nimodipine files/GCaMPSlice_peaks_07_16_2019_Nimodipine.csv", header=TRUE, sep = ",")
GCaMPSlice_nimodipine_2019_07_17 <- read.table("C:/Users/John PC/Documents/Summer Research 2019/R-analysis/GCaMP Baseline Nimodipine files/GCaMPSlice_peaks_07_17_2019_Nimodipine.csv", header=TRUE, sep = ",")
...
nimodipine<-rbind(GCaMPSlice_nimodipine_2019_07_11, GCaMPSlice_nimodipine_2019_07_12, GCaMPSlice_nimodipine_2019_07_15, GCaMPSlice_nimodipine_2019_07_16, GCaMPSlice_nimodipine_2019_07_17)
