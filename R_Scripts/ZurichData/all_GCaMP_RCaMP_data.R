...
rm(nostim.lck, long.lck, short.lck, nostim.lck.OT, long.lck.OT, short.lck.OT, nostim.lck.OT.2s, long.lck.OT.2s, short.lck.OT.2s)
...
respondingNeurons.OT<- subset(all.lck.OT, Channel=="RCaMP" & OnsetTime<8)

ggplot(respondingNeurons.OT,aes(x=OnsetTime)) +
  geom_histogram(binwidth=0.084, position="dodge") +
  max.theme

Neuron95Onset<-quantile(respondingNeurons.OT$OnsetTime, prob = seq(0, 1, length = 21), type = 5)
...
# remove the data frames that are combined
rm(nostim.cyto, long.cyto, short.cyto, nostim.cyto.OT, long.cyto.OT, short.cyto.OT, nostim.cyto.OT.2s, long.cyto.OT.2s, short.cyto.OT.2s)
