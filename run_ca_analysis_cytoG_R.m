...
SaveFiles{1,1} = fullfile(Settings.MainDir, 'Results', 'test_cGC&RC_17_02_2017.csv');%'Control_Peaks_3Conds.csv'); % all data
SaveFiles{1,2} = fullfile(Settings.MainDir, 'Results', 'test_cGC&RC_17_02_2017.mat');%'Control_Peaks_3Conds.csv'); % all data
SaveFiles{1,3}= fullfile(Settings.MainDir, 'Results','test_cGC&RC_traces_17_02_2017.mat'); %'Control_TraceAUC_20sWindow_3Conds.csv'); % neuronal hand click cell scan
...
% final data file name
SaveFiles{1,1} = fullfile(Settings.MainDir, 'Results', 'LStim_cGC&RC_17_02_2017.csv');%'Control_Peaks_3Conds.csv'); % all data
SaveFiles{1,2} = fullfile(Settings.MainDir, 'Results', 'LStim_cGC&RC_17_02_2017.mat');%'Control_Peaks_3Conds.csv'); % all data
SaveFiles{1,3}= fullfile(Settings.MainDir, 'Results','LStim_cGC&RC_traces_17_02_2017.mat'); %'Control_TraceAUC_20sWindow_3Conds.csv'); % neuronal hand click cell scan
...
% final data file name
SaveFiles{1,1} = fullfile(Settings.MainDir, 'Results', 'DSP4_cGC&RC_17_02_2017.csv');%'Control_Peaks_3Conds.csv'); % all data
SaveFiles{1,2} = fullfile(Settings.MainDir, 'Results', 'DSP4_cGC&RC_17_02_2017.mat');%'Control_Peaks_3Conds.csv'); % all data
SaveFiles{1,3}= fullfile(Settings.MainDir, 'Results','DSP4_cGC&RC_traces_17_02_2017.mat'); %'Control_TraceAUC_20sWindow_3Conds.csv'); % neuronal hand click cell scan
...
% final data file name
SaveFiles{1,1} = fullfile(Settings.MainDir, 'Results', 'S&LStim_LckGC&RC_17_02_2017.csv');%'Control_Peaks_3Conds.csv'); % all data
SaveFiles{1,2} = fullfile(Settings.MainDir, 'Results', 'S&LStim_LckGC&RC_17_02_2017.mat');%'Control_Peaks_3Conds.csv'); % all data
SaveFiles{1,3}= fullfile(Settings.MainDir, 'Results','S&LStim_LckGC&RC_traces_17_02_2017.mat'); %'Control_TraceAUC_20sWindow_3Conds.csv'); % neuronal hand click cell scan
    ...
    for iSpot = 1:length(spots) % looks at every 2nd line of SpotIDs-
        ...
        for iCond = 1:length(Settings.NameConditions)
            ...
            testRoot =SpotPaths{PathIdx};
                ...
                % FLIKA selected
                    findConf{4} = ConfigFindROIsFLIKA_2D.from_preset('ca_neuron', 'baselineFrames',...
                    BL_frames,'freqPassBand',1,'sigmaXY', 2,...
                    'sigmaT', 0.1,'threshold_std', 10, 'threshold2D', 0.2,...
                    'min_rise_time',0.0845, 'max_rise_time', 1,'minPuffArea', 10,...
                    'minPuffTime',0.25,'dilateXY', 2, 'dilateT', 0.3,'erodeXY', 1, 'erodeT', 0.1,...
