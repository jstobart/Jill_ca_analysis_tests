...
SaveFiles{1,1} = fullfile(Settings.MainDir, 'Results', 'S&LStim_cGC&RC_14_02_2017.csv');%'Control_Peaks_3Conds.csv'); % all data
SaveFiles{1,2} = fullfile(Settings.MainDir, 'Results', 'S&LStim_cGC&RC_14_02_2017.mat');%'Control_Peaks_3Conds.csv'); % all data
SaveFiles{1,3}= fullfile(Settings.MainDir, 'Results','S&LStim_cGC&RC_traces_14_02_2017.mat'); %'Control_TraceAUC_20sWindow_3Conds.csv'); % neuronal hand click cell scan
...
% final data file name
SaveFiles{1,1} = fullfile(Settings.MainDir, 'Results', 'DSP4_cGC&RC_14_02_2017.csv');%'Control_Peaks_3Conds.csv'); % all data
SaveFiles{1,2} = fullfile(Settings.MainDir, 'Results', 'DSP4_cGC&RC_14_02_2017.mat');%'Control_Peaks_3Conds.csv'); % all data
SaveFiles{1,3}= fullfile(Settings.MainDir, 'Results','DSP4_cGC&RC_traces_14_02_2017.mat'); %'Control_TraceAUC_20sWindow_3Conds.csv'); % neuronal hand click cell scan
