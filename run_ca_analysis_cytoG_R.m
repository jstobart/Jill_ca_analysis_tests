...
SaveFiles{1,1} = fullfile(Settings.MainDir, 'Results', 'test_cGC&RC_01_2017.csv');%'Control_Peaks_3Conds.csv'); % all data
...
SaveFiles{1,5}= fullfile(Settings.MainDir, 'Results','test_cGC&RC_AUC_01_2017.csv'); %'Control_TraceAUC_20sWindow_3Conds.csv'); % neuronal hand click cell scan
